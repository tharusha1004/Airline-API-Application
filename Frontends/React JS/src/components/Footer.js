  ...
  return (
    <CDBFooter className="shadow ">
      <CDBBox
        ...
        alignItems="center"
        className="mx-auto py-4 flex-wrap absolute bottom-0 w-full"
        style={{ width: '80%' }}
      >
        <CDBBox display="flex" alignItems="center">
          <a href="/" className="d-flex align-items-center p-0 text-dark">
            <img
              ...
              width="30px"
            />
            <span className="grid ml-5 h5 mb-0 font-weight-bold">Copyright &copy;2022 Flight Finder All RightReserved.</span>
